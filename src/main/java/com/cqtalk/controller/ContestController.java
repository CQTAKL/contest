...
//    获取枚举类型的值
    ...
    //添加竞赛信息
    @PostMapping("/insert")
    public ObjectResult<String> save(HttpServletRequest request, @RequestBody Contest contest){
...
//    修改竞赛信息
    @PutMapping("/change")
    public ObjectResult<String> updateContestById(HttpServletRequest request,@RequestBody Contest contest){
...
//    删除竞赛信息
    ...
    public ObjectResult<String> deleteContestById(HttpServletRequest request,@RequestBody Contest contest){
